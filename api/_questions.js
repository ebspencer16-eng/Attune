...
export const LIFE_QUESTIONS = [
  ...
  { id: "lq_involve_user", category: "Family", text: "When considering in-person visits and/or digital communications, what level of involvement do you expect to have with {userName}'s family",
    options: ["Very little, if any", "Minimal, by design", "Casual relationship", "Consistent contact", "Frequent, deeply integrated"] },
  { id: "lq_involve_partner", category: "Family", text: "When considering in-person visits and/or digital communications, what level of involvement do you expect to have with {partnerName}'s family",
    options: ["Very little, if any", "Minimal, by design", "Casual relationship", "Consistent contact", "Frequent, deeply integrated"] },
