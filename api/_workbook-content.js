...
export const GAP_BLURBS = {
  ...
  bids: {
    aligned:     "You catch each other\'s bids at similar rates. Everyday gestures land. The quiet substrate of the relationship is working.",
    some_gap:    "You respond to bids slightly differently. One of you may reach more than the other notices, or in a register the other isn\'t tuned to.",
    notable_gap: "You respond to bids at very different rates. Missed reaches accumulate, even when neither of you intends them to.",
  },
  conflict: {
    aligned:     "You handle conflict at similar speeds. Both engage now or both want space first. The timing itself isn\'t the fight.",
    some_gap:    "You handle conflict at slightly different speeds. When one wants to address and the other wants to wait, the friction shows up.",
    notable_gap: "You handle conflict at very different speeds. One needs to engage now while the other needs space first. Without an agreement, conflicts can compound.",
  },
  repair: {
    aligned:     "You repair similarly. Both need the same kind of close, whether verbal or through warmth. Hard moments tend to end cleanly for both of you.",
    some_gap:    "You repair slightly differently. The risk is that one of you may think it\'s done while the other is still circling.",
    notable_gap: "You repair in very different ways. One needs verbal close, while the other moves on once warmth returns. Unnamed, the same fight can repeat.",
  },
  closeness: {
    ...
    notable_gap: "You want notably different amounts of closeness. One reaches more, while the other defaults to space. Without intention, it can become unbalanced.",
  },
  love: {
    aligned:     "You give and receive love in compatible ways. What lands for one tends to land for the other. Less translation needed.",
    ...
    notable_gap: "You give and receive love in very different ways. One needs words; the other needs presence and action. Both are real. Neither replaces the other.",
  },
  stress: {
    aligned:     "You handle stress in similar ways. Either you both reach out or both pull in. Two matching stress responses don\'t compound the stress.",
    ...
    notable_gap: "You handle stress in opposite directions. One needs a listener, while the other needs the room cleared. The wrong answer can make it worse.",
  },
  feedback: {
    ...
    notable_gap: "You give and receive feedback in very different ways. One brings it directly, while the other softens or holds. Useful conversations need both of you stretching.",
  },
};
...
export const WHEN_THIS_SHOWS_UP = {
  ...
  needs: {
    WW: "Both of you can default to hoping the other will notice, then feeling let down when they don\'t. Ask directly, once, even when it feels clunky. Hints are not a contract.",
    XX: "Both of you handle needs privately rather than add to the other\'s load. Generous, and also how you can both end up depleted. Ask for the small thing before it becomes a big thing.",
    YY: "Both of you need time to figure out what you want before asking, so the ask often comes late. Trust that \'I think I need X, not sure yet\' is a valid way to start.",
    ZZ: "Neither of you broadcasts. The repair is a weekly question: \'Is there anything you need that I\'m not giving you?\' The answer may take time. Ask anyway.",
    ...
    WY: "[W partner name] asks for what they need; [Y partner name] can quietly set their own aside. Build a rule. Every ask gets a counter-check: \'What do you need this week?\' before [Y partner name] mentions it.",
    WZ: "[W partner name] will ask directly; [Z partner name] usually won\'t. Create a reliable moment, Sunday dinner or a weeknight ritual, where [Z partner name] is explicitly asked what they need for the week.",
    XY: "[X partner name] names needs practically, while [Y partner name] often has needs not yet articulated. [X partner name] may read [Y partner name]\'s hesitation as \'no real need,\' but that read is wrong. Give [Y partner name] 24 hours to come back, and follow up.",
    XZ: "Both of you hold needs back. The fix is explicit: a scheduled check-in where each names one thing, even small. \'I\'d like a quiet night Thursday.\' Normalize the casual ask.",
    YZ: "Both of you wait until the need is obvious. Ask before it\'s obvious: \'How\'s your tank this week?\' as a standing question. [Z partner name] may need a moment to answer. That\'s fine.",
  },
  bids: {
    WW: "Both of you are usually good at catching bids, but a missed one stings more when it comes from someone who usually catches them. When you notice, circle back. Don\'t let misses quietly stack.",
    XX: "Both of you express bids through action more than words. Learn each other\'s versions. A \'want help with this\' is often the bid. So is a shared task or a look across the room.",
    YY: "Your bids tend to be gentle, a song they liked, a comment about the weekend. They can be easy to miss, and easy to underweight. Match the register. A soft return is the right answer to a soft bid.",
    ZZ: "Your bids may be the quietest of any pairing. A hand brushed, a book left on the counter. If one is missed, neither of you usually tries again that day. Watch for the small things.",
    WX: "[W partner name] makes a big warm bid; [X partner name] tends to respond practically. Both are real. They simply land differently. [W partner name] can name the response they\'d like. [X partner name] holds for a moment on warmth before moving to logistics.",
    WY: "[W partner name] reaches warmly; [Y partner name] receives it but takes a moment to return. The delay is recovery time, not distance. [Y partner name] can offer a small nod or look to mark the bid landed.",
    ...
    XY: "[X partner name] bids practically; [Y partner name] bids emotionally. Different registers. Learn the translation. [Y partner name]\'s emotional check-in is the bid. [X partner name]\'s offer to help is the bid. Don\'t require them to match.",
    ...
    YZ: "[Y partner name] extends a soft bid; [Z partner name] is often still in their own processing. Neither of you is pushy, so bids can evaporate. Build a small daily ritual, dinner or a walk, where bids can land.",
  },
  conflict: {
    ...
    YY: "Neither of you wants to engage in the heat. Both need distance first. Valid, and it means someone has to come back. Agree in advance: 24 hours max before one of you reopens it.",
    ...
    WX: "[W partner name] wants to surface feelings in the heat; [X partner name] wants to solve the problem logically. Split it. Name the feeling first, then the thing to solve. Neither gets skipped.",
    WY: "[W partner name] is ready to engage; [Y partner name] is often already at capacity. Agree on a pause protocol ahead of time. When one needs space, the pause has a time-stamp. Come back when you said you would.",
    WZ: "[W partner name] wants to talk it through; [Z partner name] has gone completely quiet. Pursuer-withdrawer patterns can live here. Slow [W partner name] down. Give [Z partner name] a specific return time. Build the script when things are calm.",
    XY: "[X partner name] wants to resolve; [Y partner name] still needs to process. Hesitation isn\'t avoidance, and efficiency isn\'t \'not caring.\' Name it: \'I need to sort this tonight; you need tomorrow.\' Then negotiate.",
    XZ: "Both of you want to let it go, but both of you carry the residue. Make a specific time each week to revisit anything unsaid. It will feel clunky. Do it anyway.",
    YZ: "Both of you need space, and both of you wait. Decide in advance who comes back first. The other won\'t feel pressed. The first will know the ask is expected.",
  },
  repair: {
    ...
    YY: "Both of you repair slowly, and both can underestimate how much the other needs. Assume 48 hours before you call it done. Check in on day three if either of you is still sitting with something.",
    ...
    WX: "[W partner name] wants verbal closure: \'we\'re good, we worked it out.\' [X partner name] considers it repaired once the logic is sorted. [W partner name] gets their sentence. [X partner name] holds for one more moment than feels necessary.",
    WY: "[W partner name] wants to close the loop, while [Y partner name] still needs to land somewhere. [W partner name] can say \'no rush, we\'ll come back.\' [Y partner name] marks progress with a hand or a look so the silence doesn\'t read as distance.",
    WZ: "[W partner name] wants to verbally repair; [Z partner name] has gone inward. [Z partner name] isn\'t refusing repair, just processing. Give it a full day. Look for one clear signal that [Z partner name] is back.",
    XY: "[X partner name] confirms the logical resolution; [Y partner name] often still sits with the emotional layer. Mark both. Two sentences: \'Here\'s what we agreed\' + \'I know this one took a moment for you.\'",
    XZ: "Both of you move on quietly. Works for most things. For the bigger ones, one of you should say out loud: \'I want to make sure we\'re actually repaired here.\'",
    YZ: "Both of you need time, and both can leave the final check implicit. Build in a 48-hour follow-up. A one-liner is enough: \'We good after Monday?\'",
  },
  closeness: {
    WW: "Both of you want closeness, and both can also expect it to happen on its own. Build one small ritual that doesn\'t require organizing, like a ten-minute talk or a shared morning routine.",
    XX: "Both of you value shared activity over shared conversation, which can make closeness feel procedural. Schedule one casual thing that isn\'t about logistics: a walk, a show, dinner without phones.",
    YY: "Both of you value independence, and both of you can let that tip into parallel lives. One small weekly overlap, a meal or a walk, can anchor the closeness.",
    ...
    WX: "[W partner name] wants a lot of connection; [X partner name] wants side-by-side presence. Both are valid forms of closeness. They simply look different. Alternate. One night [W partner name]\'s way, one [X partner name]\'s. Both count.",
    WY: "[W partner name] wants a bigger version of closeness; [Y partner name] needs it quieter. Different channels. [W partner name] can turn the volume down without turning the signal off. [Y partner name] turns it up slightly on purpose.",
    WZ: "[W partner name] bids frequently; [Z partner name] responds rarely but deeply. [W partner name] can feel unmet, while [Z partner name] can feel crowded. Lower the frequency, raise the intention. One thing a week with [Z partner name]\'s full attention.",
    XY: "[X partner name] offers closeness practically; [Y partner name] offers it emotionally. Learn the translation. Shared logistics is closeness for [X partner name]. Being seen is closeness for [Y partner name]. Both can happen in the same week.",
    XZ: "Both of you are comfortable with independence, and both of you can also drift. Anchor with a ritual that isn\'t about talking: cooking, a show, a walk. Closeness doesn\'t always require a conversation.",
    YZ: "Both of you will wait the other out. Decide in advance what \'too much space\' looks like (a week, three days, whatever you agree on) and reengage before that threshold.",
  },
  love: {
    WW: "Both of you are actively loving, which can make the misses feel especially strange. Tell each other plainly: \'this is what lands for me.\' Specific and concrete, not abstract.",
    XX: "Both of you show love by doing, and both can underweight how much the other wants to hear it. Say it out loud, even when you think it\'s obvious.",
    YY: "Both of you express love gently, and both can wonder if the other still feels it. Ask directly: \'Do you feel loved by me right now?\' Don\'t assume. Ask.",
    ...
    WX: "[W partner name] expresses love verbally; [X partner name] expresses it through care and effort. Both are real. [W partner name] needs to hear it, while [X partner name] needs to see it. Say it out loud and show up consistently.",
    WY: "[W partner name] is expressive; [Y partner name] returns it more softly. Not less. Softly. [W partner name] can match [Y partner name]\'s register sometimes. [Y partner name] can push past the quieter default once in a while.",
    WZ: "[W partner name] is openly loving; [Z partner name] shows love through presence and reliability. [W partner name] may feel that [Z partner name] holds back. [Z partner name] may feel that [W partner name] performs. Match the other\'s channel once a week.",
    XY: "[X partner name] loves practically; [Y partner name] loves emotionally. [X partner name] can add a word about the feeling, not just the task. [Y partner name] can acknowledge the task, not just the feeling. Both stretch a little.",
    XZ: "Both of you prefer love expressed through reliable action, and both can miss the words. Add them occasionally, without ceremony. \'I\'m glad it\'s you.\' That\'s enough.",
  ...
  stress: {
    WW: "Both of you reach toward each other under stress, which is good. The risk is that you can both lean on someone equally depleted. One of you names the load first. The other takes one thing off their plate.",
    ...
    YY: "Both of you withdraw under pressure. The repair is a specific ritual. Weekly, name one thing each of you is carrying. No solution required, just put it in the room.",
    ...
    WX: "[W partner name] talks through stress; [X partner name] keeps theirs internal. [W partner name] needs a listener, while [X partner name] needs their plate cleared without a conversation. Do both, in the right direction.",
    WY: "[W partner name] reaches for connection under stress; [Y partner name] needs to retreat. [W partner name] gives [Y partner name] space first. [Y partner name] comes back with a specific \'I\'m ready now\' signal. Both trust the return.",
    WZ: "[W partner name] wants to share the stress; [Z partner name] wants to handle it alone. [W partner name] can offer support without requiring a conversation. [Z partner name] names the stress once, briefly. A single sentence is enough.",
    XY: "[X partner name] manages stress practically; [Y partner name] manages it through processing. [X partner name] can take things off [Y partner name]\'s plate. [Y partner name] can help [X partner name] slow down when they\'re overfunctioning.",
    ...
    YZ: "Both of you wait for the other to notice. You usually won\'t. Name it plainly, even when it feels like a burden to say. \'I\'m running low this week\' is enough. No elaboration required.",
  },
  feedback: {
    ...
    YY: "Both of you wait for the right moment, but the right moment rarely arrives on its own. Build a weekly check-in where each offers one small piece of feedback. Normal volume, normal tone.",
    ...
    WX: "[W partner name] gives feedback with emotion attached; [X partner name] wants it delivered as logic. [W partner name] strips the edge. [X partner name] absorbs the emotional layer without requiring it to be removed. Both are a stretch.",
    WY: "[W partner name] raises feedback in real time, while [Y partner name] needs more warning. Heads-up first: \'I have something I want to mention, when\'s good?\' [W partner name] gets to say it; [Y partner name] gets to receive it well.",
    WZ: "[W partner name] delivers feedback openly; [Z partner name] processes it internally and slowly. [W partner name] may want an immediate response. Don\'t push for one. Give [Z partner name] time, even a full day. The response will be better.",
    XY: "[X partner name] gives feedback concisely; [Y partner name] needs more relational framing. [X partner name] can add one line of context (\'this matters because...\') without changing the substance. [Y partner name] holds the feedback without requiring the context to expand.",
    ...
    YZ: "Both of you want to deliver it well, and both can also overwait. Set a shorter threshold (within a week) for anything worth saying.",
  },
};
