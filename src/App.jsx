...
const FONT_LINK = "https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&family=DM+Sans:wght@300;400;500;600;700&display=swap";
...
const FONT_URL = "https://fonts.googleapis.com/css2?family=Syne:wght@700;800;900&family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&family=DM+Sans:wght@300;400;500;600&display=swap";
    ...
    <div style={{ position: "fixed", inset: 0, zIndex: 500, display: "flex", alignItems: isMobile ? "flex-start" : "center", justifyContent: "center", padding: isMobile ? "0" : "1rem", overflowY: "auto", background: "linear-gradient(180deg,#FBF6EE 0%,#F8EDE0 40%,#F2D9C8 75%,#FFFDF9 100%)" }}
      ...
      <div style={{ background: "white", borderRadius: isMobile ? 0 : 32, padding: isMobile ? "1.5rem 1.25rem 1.25rem" : "2.5rem 2.25rem 2rem", width: "100%", minHeight: isMobile ? "100vh" : "auto", maxWidth: isMobile ? "none" : 460, boxShadow: isMobile ? "none" : "0 4px 8px rgba(60,30,10,.05),0 14px 32px rgba(60,30,10,.10)", border: isMobile ? "none" : "1px solid #E2D5C2", position: "relative", animation: shake ? "authShake 0.45s cubic-bezier(.36,.07,.19,.97)" : undefined, overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "1.25rem", position: "relative", zIndex: 1 }}>
          ...
          <span style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "1.05rem", fontWeight: 600, color: "#0E0B07" }}>Attune</span>
        </div>

        {/* Editorial headline — opsz 72 Newsreader, 500 weight */}
        <div style={{ fontFamily: "'Playfair Display',Georgia,serif", fontVariationSettings: "'opsz' 72", fontSize: "1.85rem", fontWeight: 500, color: "#0E0B07", lineHeight: 1.1, letterSpacing: "-0.02em", marginBottom: "0.4rem", position: "relative", zIndex: 1 }}>
  ...
  return (
    <div style={{ background: "linear-gradient(150deg,#1c1940 0%,#282560 60%,#1e3a6e 100%)", color: "white", padding: isMobile ? "2.5rem 1.25rem 3rem" : "3.25rem 2rem 3.5rem", marginLeft: isMobile ? "-1.25rem" : "-2rem", marginRight: isMobile ? "-1.25rem" : "-2rem", marginTop: isMobile ? "-1.5rem" : "-2rem", marginBottom: "1.75rem", position: "relative", overflow: "hidden", borderRadius: 0 }}>
      ...
      <div style={{ position: "relative", maxWidth: 760, zIndex: 2 }}>
        ...
        <div style={{ fontFamily: "'Playfair Display',Georgia,serif", fontVariationSettings: "'opsz' 72", fontWeight: 500, fontSize: isMobile ? "2.1rem" : "clamp(2.4rem,4.4vw,3rem)", lineHeight: 1.04, letterSpacing: "-0.024em", marginBottom: "0.75rem", color: "white" }}>
          {userName}
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                    <div>
                      <div style={{ display: "flex", alignItems: "baseline", gap: "0.35rem", flexWrap: "wrap" }}>
                        <span style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "1.3rem", fontWeight: 700, lineHeight: 1, letterSpacing: "-.02em", color: "white" }}>{userName || "You"}</span>
                        <span style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "0.95rem", fontWeight: 400, fontStyle: "italic", color: "rgba(255,255,255,0.5)", lineHeight: 1 }}>&</span>
                        <span style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "1.3rem", fontWeight: 700, lineHeight: 1, letterSpacing: "-.02em", color: "white" }}>{partnerName || "Partner"}</span>
                      </div>
                    </div>
                  </div>
                </div>
