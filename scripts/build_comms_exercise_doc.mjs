...
import { run, eyebrow, title, h1, body, small, kv, rule, saveDoc, ORANGE, BLUE, INK, MUTED } from './_doc_style.mjs';
...
children.push(body('24 forced-choice questions. Each maps to one of 10 communication dimensions, which roll up into two axes: Engage / Withdraw and Open / Guarded. There is no right answer. Each option describes a real, workable way of relating. The point is where each partner sits, and where the two of you differ.'));
...
children.push(rule());
children.push(small('Total questions: ' + PERSONALITY_QUESTIONS.length + '. Dimensions: ' + DIMS.length + '.'));
